	  ...
	  render: function render() {
	    ...
	    if (this.state.board.lost() || this.state.board.won()) {
	      ...
	      modal = React.createElement(
	        'div',
	        { className: 'modal-screen', __self: this
	        },
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            'button',
	            { onClick: this.restartGame, __self: this
	            },
	            'Play Again'
	          )
	        )
	    ...
	    return React.createElement(
	      ...
	      modal,
	      React.createElement(Board, { board: this.state.board, updateGame: this.updateGame, __self: this
	      })
	    );
	  }
	});
	...
	var Board = React.createClass({
	  ...
	  renderRows: function renderRows() {
	    ...
	    return board.grid.map(function (row, i) {
	      return React.createElement(
	        'div',
	        { className: 'row', key: 'row-' + i, __self: _this
	        },
	        _this.renderTiles(row, i)
	      );
	    });
	  },
	  renderTiles: function renderTiles(row, i) {
	    var _this2 = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: klass, onClick: this.handleClick, __self: this
	      },
	      text
	    );
	  }
